...
// TODO add your handling code here:
    ...
    if(rbtndes.isSelected()==true)
    {
        ...
        String []titulos={"CODIGO","DESCRIPCIÓN","CATEGORÍA","CANTIDAD","COSTE","PRECIO","ESTADO"};
        ...
        try {
            ...
            while(rs.next())
            {
                ...
                Datos[4]=rs.getString("pro_Coste");
...
// TODO add your handling code here:
 ...
 void BuscarProductos(){
        String titulos[]={"ID","Presentación","Descripción","Concentración","Stock","Coste","Venta","Vencimiento","Registro Sanitario","Laboratorio","Estado"};
