...
public class frmCompras extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 70, 40));
        ...
        jPanel2.add(txtCodigoProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 100, 25));
        ...
        jPanel1.add(jPanel4);
        jPanel4.setBounds(10, 260, 650, 49);
        ...
        txtNumeroCompra.setBounds(770, 100, 110, 19);
        ...
        txtIdComprobante.setBounds(580, 440, 40, 19);

        txtFecha.setEditable(false);
        jPanel1.add(txtFecha);
        txtFecha.setBounds(20, 480, 59, 19);

        txtTipoPago.setEditable(false);
        jPanel1.add(txtTipoPago);
        txtTipoPago.setBounds(660, 160, 110, 19);

        txtIdProveedor.setEditable(false);
        jPanel1.add(txtIdProveedor);
        txtIdProveedor.setBounds(650, 190, 130, 19);
        ...
        txtUltimoId.setBounds(660, 220, 40, 19);
