...
private Connection connection=new ConexionBD().conectar();
    ...
    public int GuardarCompras( String Numero, String Fecha, String TipoPago, String SubTotal, String Total, String Iva, String Estado, String IdProveedor, String IdEmpleados, String IdTipoComprobante) {
        int resultado = 0;
        Connection conexion = null;

        String sentencia_guardar = "INSERT INTO compra (Numero, Fecha, TipoPago, SubTotal, Total, Iva, Estado, idProveedor, idEmpleado, idTipoComprobante) VALUES (?,?,?,?,?,?,?,?,?,?)";
    ...
    public int GuardarDetalleCompras( String IdCompra, String IdProducto, String Cantidad, String Costo, String Total) {
        ...
        String sentencia_guardar = "INSERT INTO detallecompra (idCompra, idProducto, Cantidad, Coste, Importe) VALUES (?,?,?,?,?)";
