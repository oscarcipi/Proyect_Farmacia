...
public class Metodos_Ventas {
    ...
    public int ActualizarDatos(String ID, String Serie, String Numero, String Descripcion, String Categoria, int Cantidad, float Iva, float Costo, float Precio, String Estado) {
        String SQL = "UPDATE producto SET Serie = '" +  Serie + "', Numero = '" +  Numero + "', pro_Descripcion = '" + Descripcion + "', pro_Categoria = '" + Categoria + "', pro_Cantidad = '" + Cantidad + "', Iva = '" + Iva + "', pro_Costo = '" + Costo + "', pro_Precio = '" + Precio + "', pro_Estado = '" + Estado + "' WHERE pro_ID = " + ID;
        int resultado = 0;
    ...
    public int GuardarVentas( String Serie, String Numero, String Fecha, String VentaTotal, String Descuento, String SubTotal, String Iva, String Total, String Estado, String IdCliente, String IdEmpleado, String IdTipoComprobante) {
        int resultado = 0;
        Connection conexion = null;

        String sentencia_guardar = "INSERT INTO ventas (Serie, Numero, Fecha, VentaTotal, Descuento, SubTotal, Iva, Total, Estado, IdCliente, IdEmpleado, IdTipoComprobante) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
