...
(1, 'Andrea', 'Gonzalez Saez', 'F', '72148232', '653417272', 'andrea@gmail.com', 'Larreta'),
(2, 'Fernando', 'Carvajal Lopez', 'M', '73156740', '655417823', 'fernandito@gmail.com', 'principal'),
(3, 'Carmen', 'Lorenzo Saez', 'F', '71902256', '641829211', 'lomencar@gmail.com', 'picosdeeuropa'),
(4, 'Nani', 'Gonzalez Guzon', 'M', '71328596', '616683320', 'nani@gmail.com', 'avenidacastro'),
(5, 'Sara', 'Fernandez Arribas', 'F', '71832691', '686683338', 'sarita@gmail.com', 'centromayor');
...
INSERT INTO `compra` (`idCompra`, `Numero`, `Fecha`, `TipoPago`, `SubTotal`, `Total`, `Iva`, `Estado`, `idProveedor`, `idEmpleado`, `idTipoComprobante`) VALUES
...
INSERT INTO `detallecompra` (`idCompra`, `idProducto`, `Cantidad`, `Coste`, `Importe`) VALUES
(1, 3, 29, '2.00', '58.00'),
(2, 1, 20, '0.30', '6.00'),
(2, 3, 15, '1.50', '22.50'),
(3, 4, 20, '0.30', '6.00'),
...
INSERT INTO `detalleventa` (`IdVenta`, `idProducto`, `Cantidad`, `Coste`, `Precio`, `Importe`) VALUES
...
(1, 'Oscar', 'Cipitria Lorenzo', 'Administrador', 'M', 72148231, 'oscarzipitria@gmail.com', 653416897, 'Joaquin Cayon 18', '8:00 am', '5:00 pm', '2800.00', 'Activo', 1),
(3, 'Lidia', 'Andres Gonzalez', 'Administrador', 'M', 71902265, 'lidia_ag@gmail.com', 686683410, 'Calle Ramon Mendoza', '8:00 am', '5:00 pm', '2500.00', 'Activo', 2),
(4, 'Maria ', 'Garcia Sanchez', 'Enfermera', 'F', 33428516, 'maria@gmail.com', 984162357, 'Av. España', '7:00 am', '5:00 pm', '1800.00', 'Activo', 0),
(5, 'Andrea ', 'Pison Martin', 'Enfermera', 'F', 33451264, 'andrea_pison@hotmail.com', 942631057, 'Av. Circunvalacion 610', '5:00 pm', '10:00 pm', '1500.00', 'Activo', 0),
(6, 'Leticia ', 'Lopez Comos', 'Tecnica Enfermera', 'F', 334125697, 'leticia@hotmail.com', 945103782, 'Av. Central', '8:00 am', '5:00 pm', '1500.00', 'Inactivo', 0),
(10, 'Bobby', 'Mihai Dringa', 'Enfermero', 'M', 71913061, 'bobby@gmail.com', 913745861, 'Av. Los Castros', '7:00 am', '1:00 pm', '1200.00', 'Activo', 0);
...
(1, 'PHARMA', 'Madrid', 985481300, 'Activo'),
(2, 'NATURALFARMA', 'Barcelona', 985733594, 'Activo'),
(3, 'FARNIN', 'Tarragona', 912475603, 'Activo'),
(4, 'FarmaFlein', 'Girona', 947203651, 'Activo'),
(5, 'FLEXFARMA', 'Leon', 917859632, 'Activo'),
(6, 'CLEANMARK', 'Santander', 418759632, 'Activo');
...
INSERT INTO `producto` (`idProducto`, `Descripcion`, `Concentracion`, `Stock`, `Coste`, `Precio_Venta`, `RegistroSanitario`, `FechaVencimiento`, `Estado`, `idPresentacion`, `idLaboratorio`) VALUES
(1, 'Ibuprofeno', '500 mg', 90, '0.30', '0.50', 'EN01867', '2021-08-08', 'Activo', 27, 6),
(2, 'Hepabionta', '10mg /30ml', 90, '13.00', '16.00', 'EN06374', '2022-08-14', 'Activo', 14, 4),
(3, 'Paracetamol', '500 mg', 150, '1.50', '2.50', 'EN01596', '2021-08-08', 'Activo', 27, 5),
(4, 'Naproxeno', '400 mg', 180, '0.30', '0.50', 'EE035471', '2022-08-11', 'Activo', 3, 4),
(5, 'Tylenol', '15 mg / 20ml', 40, '3.20', '3.80', 'EE03459', '2021-08-29', 'Inactivo', 7, 6),
(6, 'Penicilina', '500 mg', 50, '4.00', '4.80', 'EN03449', '2021-08-05', 'Activo', 14, 3),
(7, 'Flenadol', '1 %', 20, '8.50', '9.80', 'EE01298', '2021-08-16', 'Activo', 16, 3),
(8, 'Apronax', ' 500 mg', 100, '0.50', '0.80', 'EE032145', '2021-08-13', 'Inactivo', 27, 4),
(9, 'Panadol', '400 mg', 5, '2.80', '3.20', 'EE06185', '2021-08-22', 'Activo', 27, 8);
...
INSERT INTO `proveedor` (`IdProveedor`, `Nombre`, `Dni`, `Direccion`, `Email`, `Telefono`, `Banco`, `Cuenta`, `Estado`) VALUES
(1, 'Alberto Gutierrez Fernandez', '71652341', 'Joaquin Cayon', 'guti250@hotmail.com', '6764126222', 'CAIXA', '1032456759484', 'Activo'),
(2, 'ELIFARMA', '', 'Av. Vicente Trueba', '', '942887245', 'BBVA', '0126544949944884', 'Activo');
...
(1, 'Oscar', 'Cipitria Lorenzo ', 72148231, 'oscarzipitria@gmail.com', 'cipi', 'cipitria', 'Administrador', 'Activo'),
(2, 'Luis', 'Moura Felis', 72137217, 'luisin@gmail.com', 'LuisMoura', '1234', 'Vendedor', 'Activo');
...
INSERT INTO `ventas` (`IdVenta`, `Serie`, `Numero`, `Fecha`, `VentaTotal`, `Descuento`, `SubTotal`, `Iva`, `Total`, `Estado`, `idCliente`, `idEmpleado`, `idTipoComprobante`) VALUES
